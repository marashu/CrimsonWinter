...
//login details
    ...
    $my_url = "http://apps.facebook.com/crimsonwinter/collection.php";
...
<div class="profileButtons2">
<table style="top:9px; width:400px; text-align:center; position:absolute; left:199px;">
<tr><td style='width:105px; border:0px; padding:0px;'><a href="inventory.php?token=$access_token">MY POWERS</a></td><td style='width:145px; border:0px; padding:0px;'><a href="store.php?token=$access_token">TRAINING</a></td><td style='width:105px; border:0px; padding:0px;'><a class='button' href='collection.php?token=$access_token'>COLLECTION</a></td><td style='width:55px;'></td></tr></table>
</div>
<!--Display the different collections the player could earn-->
<table class='offence'><tr><th style=" background-image:url('assets/BG_box4x4.png');">SAND AND SUN COLLECTION</th></tr><tr>
_END;
$counter = 1;
$displayBoosts = 0;
for($i = 0; $i < count($powers); $i++)
...
_END;
					echo "<div style='position:relative; width:64px; height:64px;left:30px;'><img src='assets/power" . $powerID[$i] . ".jpg' style='position:absolute; text-align:center;'/></div><br/>$thisPower<br/>Owned: $powers[$i] </td>";
					$counter++;
...
<td style="width:182px; height:158px; background-image:url('assets/Box_TrainingItem.png'); text-align:center;color:black;">
_END;
					echo "<div style='position:relative; width:64px; height:64px;left:30px;'><img src='assets/power" . $powerID[$i] . ".jpg' style='position:absolute; text-align:center;'/><img style='width:64px; height:64px; position:absolute; text-align:center;' src='assets/BG_box4x4.png'/></div><br/>$thisPower<br/>Owned: $powers[$i] </td>";
					$counter++;
				}
				if($i + 1 >= count($powers))
				{
...
echo "<tr style='height:16px;'><td></td></tr>";
echo <<<_END
<tr style='height:16px;'><td style=" background-image:url('assets/BG_box4x4.png')";><b>SEVEN DAYS IN JADE COLLECTION</b></td></tr>
_END;
$counter = 1;
$displayBoosts = 0;
for($i = 0; $i < count($powers); $i++)
{
	...
	if($powerID[$i] >= 90  && $powerID[$i] < 106)
	{
		switch($powerType[$i])
		{
			case 4:
				if($powers[$i] > 0 && $powerID[$i] >= 90)
				{
					$thisPower = $powerName[$i];
...
<tr style='height:16px;'><td style=" background-image:url('assets/BG_box4x4.png')";><b>TAIYOU COLLECTION</b></td></tr>
_END;
$counter = 1;
$displayBoosts = 0;
for($i = 0; $i < count($powers); $i++)
{
	...
	if($powerID[$i] >= 106  && $powerID[$i] < 114)
	{
		switch($powerType[$i])
		{
			case 4:
